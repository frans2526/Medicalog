	<div class="content">
		...
		<div class="contacts">
			<ul id="patientsListe">
				...
				$check = '';
				if(count($patients) == 0){
					echo '<p style="padding-top:40px;">Aucun patient enregistré</p>';
				}else{
					foreach ($patients as $key => $value) {
						...
						echo '<li><a href="'.Routeur::url('app/patients/edit/'.$value->id.'').'">'.htmlentities($value->name, ENT_QUOTES, "UTF-8").' '.htmlentities($value->lastName, ENT_QUOTES, "UTF-8").'</a></li>';
					} 
				}
				?>
			</ul>
