...
<div class="center">
	<form action="<?php echo Routeur::url('admin/posts/edit/'.$id.'?t='.$_SESSION['token']); ?>" method="post" class="well">
		<?php echo $this->Form->input('title','Titre&nbsp;',array('placeholder' => 'Titre de la news','maxlength' => '85')); ?>
